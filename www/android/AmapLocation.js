...
module.exports = {
    ...
    init: function() {
          exec(null,null,"AMaplocation", "init",[]);
     },

    getCurrentPosition: function(success, error, args) {

        var win = function(localtion) {
             //alert(JSON.stringify(localtion));
//            var geo = cordova.require('cordova/modulemapper').getOriginalSymbol(window, 'navigator.amapLocation');
...
//            alert(JSON.stringify(geo));
        ...
        exec(win, fail, "AMaplocation", "getLocation", []);
